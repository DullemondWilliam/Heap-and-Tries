...
public class TreeNode implements TreeNodeADT{
	...
	final protected static int labelPointSize = RADIUS * 3/2;
	final protected static Font labelFont = new Font("Serif", Font.PLAIN, labelPointSize);

	final protected static int wordPointSize = RADIUS;
	final protected static Font wordFont = new Font("Serif", Font.PLAIN, wordPointSize);
	...
	protected Point     location; //drawing location of the node (center of node)
	...
	public TreeNode(DataADT aDataItem) {
		element = aDataItem;
		initialize();
	}
	...
	// TreeNodeADT methods============================================================
	public void changeShapeSquare(){oval=false;}
	public void changeShapeOval(){oval = true;}
	...
	public void setParent(TreeNode aNode) {parent = aNode;}
	...
	public ArrayList<DataADT> entries(){
		//return a list of all the Data items in the tree
	...
	public void draw(Graphics2D aPen) {
		...
		if(oval==true){
			...
			aPen.fillRect(location.x - TreeNode.RADIUS, location.y - TreeNode.RADIUS, 
					TreeNode.RADIUS * 2, TreeNode.RADIUS * 2);
			...
			aPen.drawRect(location.x - TreeNode.RADIUS, location.y - TreeNode.RADIUS, 
					TreeNode.RADIUS * 2, TreeNode.RADIUS * 2);
		}
